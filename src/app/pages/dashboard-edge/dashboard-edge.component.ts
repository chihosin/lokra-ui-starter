...
@Component({
  ...
  templateUrl: 'dashboard-edge.component.html',
  styleUrls: [
    'dashboard-edge.component.scss'
  ]
})
export class DashboardEdgeComponent implements OnInit, AfterViewInit {
    ...
    datasets: [
      {
        ...
        pointHitRadius: 0,
        spanGaps: true,
        backgroundColor: 'rgba(92, 0, 255,,0.4)',
      ...
      },
      {
        ...
        pointHitRadius: 0,
        spanGaps: true,
        backgroundColor: 'rgba(92, 0, 255,0.3)',
        borderColor: 'transparent',
      ...
      },
      {
        ...
        pointHitRadius: 0,
        spanGaps: true,
        backgroundColor: 'rgba(92, 0, 255,0.2)',
        borderColor: 'transparent',
  ...
  constructor(private appService: AppService, privateelementRef: ElementRef) {
    appService.getState().topnavTitle = 'Dashboard Edge';
    setInterval(() => {
